...
-- 23) Get employee details from employee table whose First_Name ends with 'v' and name contains 4 letters.
 select * from Employee where FIRST_NAME like '%v' and '%____%'; 
